class MinkabuFundsScoreCalculator {
  constructor() {
    ...
    this._ignoreList = [
      ...
      "ダイワDBモメンタム戦略ファンド(為替ヘッジあり)", "JPM USコア債券ファンド(為替ヘッジあり、年1回決算型)",
      ...
      "ブラックロック・ゴールド・メタル・オープンAコース", "ブラックロック・ゴールド・メタル・オープンBコース", "ダイワ投信倶楽部外国債券インデックス",
      ...
      "アムンディ・グラン・チャイナ・ファンド", "浪花おふくろファンド(おふくろファンド)", "GS日本フォーカス・グロース毎月決算コース", "スーパー小型株ポートフォリオ", 
